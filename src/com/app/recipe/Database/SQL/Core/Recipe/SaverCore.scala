...
/**
 * Abstract class sharing logic amongst all saver objects and classes.
 */
abstract class SaverCore extends SQLRecipeCore with RecipeLogging {
...
//    println(test)
  ...
  /*************************************************************************************
   *        **************************                                                                           *
   *    Aiding methods to prepare data to be saved.   *
   *                                                                                   * 
   *************************************************************************************/
