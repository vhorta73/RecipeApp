 ...
 */
object OCADOURLBuilder extends URLBuilder {
  /**
   * The searching url for Ocado after which the searching string is added.
   */
  private val SEARCH_URL_STRING = "https://www.ocado.com/webshop/getSearchProducts.do?clearTabs=yes&isFreshSearch=true&chosenSuggestionPosition=&entry="
  
  /**
   * The url to query when with a product id.
   */
  private val PRODUCT_URL_STRING = "https://www.ocado.com/webshop/product/"+Random.nextFloat()+"/"
