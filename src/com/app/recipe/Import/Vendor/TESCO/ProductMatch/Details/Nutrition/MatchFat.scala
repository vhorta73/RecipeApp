...
class MatchFat() {
  ...
  private final val FAT_G_01_REGEX = """<th scope="row">Fat \(g\)</th><td>([0-9.]+)</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>11.0g</td>
  private final val FAT_G_02_REGEX = """<th scope="row">Fat</th><td>([0-9.]+)g</td>""".r.unanchored
  // Matching: <th scope="row">Fats (g)</th><td>4.8</td>
  private final val FAT_G_03_REGEX = """<th scope="row">Fats \(g\)</th><td>([0-9.]+)</td>""".r.unanchored
  // Matching: <th scope="row">Fat:</th><td>0g</td>
  private final val FAT_G_04_REGEX = """<th scope="row">Fat:</th><td>([0-9.]+)g</td>""".r.unanchored
  // Matching: <th scope="row">Fat:</th><td>< 0.5 g</td>
  private final val FAT_G_05_REGEX = """<th scope="row">Fat:</th><td>< ([0-9.]+) g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>Negligible amount</td>
  private final val FAT_G_06_NEGLIGIBLE_REGEX = """<th scope="row">Fat</th><td>[a-zA-Z ]+(egligible amount)[a-zA-Z ]+</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>1.5 g</td>
  private final val FAT_G_07_REGEX = """<th scope="row">Fat</th><td>([0-9.]+) g</td>""".r.unanchored
  ...
  private final val FAT_G_08_NEGLIGIBLE_REGEX = """<th scope="row">[a-zA-z ]+(negligible)[^0-9.]+.*</th>""".r.unanchored
  // Matching: <th scope="row">Fat:</th><td><0.5 g</td></tr>
  private final val FAT_G_09_REGEX = """<th scope="row">Fat:</th><td><([0-9.]+) g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>Negligible amount</td><td>Negligible amount</td></tr>
  private final val FAT_G_10_NEGLIGIBLE_REGEX = """<th scope="row">Fat</th><td>(Negligible amount)</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>< 0.1g</td></tr>
  private final val FAT_G_11_REGEX = """<th scope="row">Fat</th><td>< ([0-9.]+)g</td></tr>""".r.unanchored
  // Matching: <th scope="row">Fat, saturates, protein - negligible amount</th><td>-</td>
  private final val FAT_G_12_NEGLIGIBLE_REGEX = """<th scope="row">Fat, saturates, protein - (negligible) amount</th>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>Negligible Amount</td><td>Negligible Amount</td></tr>
  private final val FAT_G_13_NEGLIGIBLE_REGEX = """<th scope="row">Fat</th><td>(Negligible) Amount</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td><0.1g</td>
  private final val FAT_G_14_REGEX = """<th scope="row">Fat</th><td><([0-9.]+)g</td>""".r.unanchored
  // Matching: <th scope="row">Trans Fatty Acids</th><td>0.1g</td>
  private final val FAT_G_15_REGEX = """<th scope="row">Trans Fatty Acids</th><td>([0-9.]+)g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>Neglibible amount</td><td>Neglibible amount</td>
  private final val FAT_G_16_NEGLIGIBLE_REGEX = """<th scope="row">Fat</th><td>(Neglibible) amount</td><td>Neglibible amount</td>""".r.unanchored
  // Matching: <th scope="row">Fat 1</th><td>1.5 g</td><td>2%</td>
  private final val FAT_G_17_REGEX = """<th scope="row">Fat 1</th><td>([0-9.]+) g</td>""".r.unanchored
  // Matching: <th scope="row">Fat, g</th><td>0</td><td>0</td>
  private final val FAT_G_18_REGEX = """<th scope="row">Fat, g</th><td>([0-9.]+)</td>""".r.unanchored
  // Matching: <th scope="row">Fat g</th><td>7</td><td>23</td>
  private final val FAT_G_19_REGEX = """<th scope="row">Fat g</th><td>([0-9.]+)</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td><0,5 g</td>
  private final val FAT_G_20_COMMA_REGEX = """<th scope="row">Fat</th><td><([0-9.,]+) g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>0,2 g</td>
  private final val FAT_G_21_COMMA_REGEX = """<th scope="row">Fat</th><td>([0-9.,]+) g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>negligible amount</td>
  private final val FAT_G_22_NEGLIGIBLE_REGEX = """<th scope="row">Fat</th><td>(negligible) amount</td>""".r.unanchored
  // Matching: <th scope="row">Total Fat</th><td>23.2g</td>
  private final val FAT_G_23_REGEX = """<th scope="row">Total Fat</th><td>([0-9.]+)g</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>trace</td><td>trace</td>
  private final val FAT_G_24_TRACE_REGEX = """<th scope="row">Fat</th><td>(trace)</td>""".r.unanchored
  // Matching: <th scope="row">Fat</th><td>9.9g(14%*)</td><td>30.5g</td></tr>
  private final val FAT_G_25_REGEX = """<th scope="row">Fat</th><td>([0-9.]+)g\([0-9%*]+\)</td>""".r.unanchored
  // Matching: <th scope="row">Fat - total</th><td>0 g</td>
  private final val FAT_G_26_REGEX = """<th scope="row">Fat - total</th><td>([0-9.]+) g</td>""".r.unanchored
  // Matching: negligible
  private final val FAT_G_27_NEGLIGIBLE_REGEX = """(negligible)""".r.unanchored
